...
export class PersonCrawler extends BaseIntervalWorker {
	...
	protected async doProcess(): Promise<void> {
		...
		if (!latestProcessedBlock && this.crawlConfig.contracts.person.firstCrawlBlock) {
			latestProcessedBlock = this.crawlConfig.contracts.person.firstCrawlBlock;
		}
